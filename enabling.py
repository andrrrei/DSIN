...
# # Открытие нужного листа в таблице
# sheet = base.sheet1

# # Получение столбца "База данных"
# matrix = sheet.get_all_values()

# # Перебор значений и вставка "Ок" в пустые ячейки
# i = 1
# while matrix[i][0]:
#     if not matrix[i][25] and not flag:
#         sheet.update_cell(f'Y{i}', 'Ок')
#     i += 1
